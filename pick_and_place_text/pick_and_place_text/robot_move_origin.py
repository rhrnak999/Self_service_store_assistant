...
tool_dict = {0: "the one", 1: "parliament", 2: "africa", 3: "dunhill", 4: "bohem", 5: "halla",
              6: "esse", 7: "raison", 8: "mevius", 9: "this plus"}
...
Gripper_diriection = [178.38, -90.11, -89.87]
# cig_home_pose = [-3.57, -50.24, 107.06, -4.60, 52.94, 92.02] # 빼는 작업 불가 -> 월드수정 전 cighome 좌표
cig_home_pose = [-3.57, -50.24, 107.06, -4.60, 52.94, 92.02] # 월드 수정 후 cig_home 좌표
